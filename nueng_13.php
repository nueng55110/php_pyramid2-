...
for($nueng_row=1;$nueng_row<=5;$nueng_row++) {
	...
	for($nueng_col=11;$nueng_col>=11;$nueng_col--){
		echo($nueng_col-$nueng_row-$nueng_row);
	}
	for($nueng_col=10;$nueng_col>=6+$nueng_row;$nueng_col--){
		echo($nueng_col-$nueng_row-$nueng_row);
	}
	for($nueng_col=5;$nueng_col>=1+$nueng_row;$nueng_col--){
		echo($nueng_col-$nueng_row);
	}
	echo "<br/>";
}
?>
